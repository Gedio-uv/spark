...
const Spark = (() => {
  ...
  const UI = {
    en: {
      ...
      levelDescBasic: 'Questions in your language, with translation below.',
      levelDescIntermediate: 'Questions in your target language, with your language below.',
      levelDescAdvanced: 'Full immersion — target language only, no translation.',
    ...
    es: {
      ...
      levelDescBasic: 'Preguntas en tu idioma, con traducción abajo.',
      levelDescIntermediate: 'Preguntas en el idioma que aprendes, con tu idioma abajo.',
      levelDescAdvanced: 'Inmersión total — solo el idioma objetivo, sin traducción.',
      premiumLabel: 'Premium',
    ...
    de: {
      ...
      levelDescBasic: 'Fragen in deiner Sprache, mit Übersetzung darunter.',
      levelDescIntermediate: 'Fragen in der Zielsprache, mit deiner Sprache darunter.',
      levelDescAdvanced: 'Volle Immersion — nur Zielsprache, keine Übersetzung.',
      premiumLabel: 'Premium',
    ...
    ru: {
      ...
      levelDescIntermediate: 'Вопросы на изучаемом языке, ваш язык ниже.',
      levelDescAdvanced: 'Полное погружение — только целевой язык, без перевода.',
      premiumLabel: 'Premium',
